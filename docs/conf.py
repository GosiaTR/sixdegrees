# -*- coding: utf-8 -*-
#
# _sixdegrees documentation build configuration file, created by
...
# of the sidebar.
html_logo = 'img/new_logo_small.png'
...
htmlhelp_basename = 'sixdegreesdoc'
...
latex_documents = [
    (master_doc, 'sixdegrees.tex', u'sixdegrees Documentation',
...
man_pages = [
    (master_doc, 'sixdegrees', u'sixdegrees Documentation',
     [author], 1)
]
